...
namespace Quantum.Editor {
  ...
  [CustomPropertyDrawer(typeof(AssetRefAIFunctionBool))]
  public class AssetRefAIFunctionBoolPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionBoolAsset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefAIFunctionByte))]
  public class AssetRefAIFunctionBytePropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionByteAsset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefAIFunctionEntityRef))]
  public class AssetRefAIFunctionEntityRefPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionEntityRefAsset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefAIFunctionFP))]
  public class AssetRefAIFunctionFPPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionFPAsset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefAIFunctionFPVector2))]
  public class AssetRefAIFunctionFPVector2PropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionFPVector2Asset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefAIFunctionFPVector3))]
  public class AssetRefAIFunctionFPVector3PropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionFPVector3Asset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefAIFunctionInt))]
  public class AssetRefAIFunctionIntPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AIFunctionIntAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(AssetRefClipData))]
  public class AssetRefClipDataPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(ClipDataAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(AssetRefGameInitData))]
  public class AssetRefGameInitDataPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(GameInitDataAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(Quantum.Prototypes.AnimationFlag_Prototype))]
